...
class GeminiAPI {
  static Future<http.Response> getSimilarBooks(String isbn) async {
    final apiKey = dotenv.env['GEMINI_API'];
    final prompt = "Pesquise o livro correspondente a $isbn e em um tom de bate papo, me retorne uma indicação de 5 livros parecidos com ele, com um tom de recomendação!";
